...
import fr.inria.astor.core.faultlocalization.predefined.PreDefinedFaultLocalization;
...
public abstract class AstorCoreEngine implements AstorExtensionPoint {
	...
	protected void loadFaultLocalization() throws Exception {
        ...
        } else if (flvalue.equals("predefined")) {
            String infoFileLoc = ConfigurationProperties.getProperty("infoFile");
            if (infoFileLoc == null) {
                infoFileLoc = System.getProperty("infoFile");
            }
            PreDefinedFaultLocalization fl = PreDefinedFaultLocalization.load(infoFileLoc);
            this.setFaultLocalization(fl);
		} else
